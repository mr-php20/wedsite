...
(function () {
  ...
  // Hero scroll indicator — smooth scroll with extra offset
  if (heroScrollIndicator) {
    heroScrollIndicator.addEventListener('click', function (e) {
      e.preventDefault();
      var target = document.getElementById('invocation');
      if (target) {
        var offset = 60;
  ...
  var translations = [
    ...
    // Footer
    { sel: '.footer > p:first-of-type', en: 'With Best Compliments from <br/><a href="https://iaraindia.com" target="_blank" rel="noopener noreferrer" style="text-decoration:underline;"><strong>Indian Academic Researchers Association</strong></a>', ta: '<a href="https://iaraindia.com" target="_blank" rel="noopener noreferrer" style="text-decoration:underline;"><strong>Indian Academic Researchers Association</strong></a> இன் வாழ்த்துக்களுடன்' },
    ...
    { sel: '.attractions-grid .attraction-card:nth-child(4) .attraction-name', en: 'Porunai Museum', ta: 'பொருநை அருங்காட்சியகம்' },
    { sel: '.attractions-grid .attraction-card:nth-child(5) .attraction-name', en: 'Sivakalai Archaeological Site', ta: 'சிவகளை அகழாய்வு' },
    { sel: '.attractions-grid .attraction-card:nth-child(6) .attraction-name', en: 'Adichanallur Archaeological Site', ta: 'ஆதிச்சநல்லூர் அகழாய்வு' },
    ...
    { sel: '.attractions-grid .attraction-card:nth-child(7) .attraction-name', en: 'Manimutharu Falls', ta: 'மணிமுத்தாறு அருவி' },
    { sel: '.attractions-grid .attraction-card:nth-child(8) .attraction-name', en: 'Agasthiyar Falls', ta: 'அகத்தியர் அருவி' },
    { sel: '.attractions-grid .attraction-card:nth-child(9) .attraction-name', en: 'Courtallam Falls', ta: 'குற்றாலம் அருவி' },
    { sel: '.attractions-grid .attraction-card:nth-child(10) .attraction-name', en: 'Tiruchendur Murugan Temple', ta: 'திருச்செந்தூர் முருகன் கோவில்' },
    // Attraction descriptions
    { sel: '.attractions-grid .attraction-card:nth-child(1) .attraction-desc', en: 'Don’t leave without the legendary wheat halwa. Try <a href="https://maps.app.goo.gl/FDzMyCoymCQKwmcEA" target="_blank" rel="noopener noreferrer" style="color:var(--maroon);text-decoration:underline;font-weight:600;">Santhi Sweets</a>!', ta: 'புகழ்பெற்ற கோதுமை அல்வா சுவைக்காமல் செல்லாதீர்கள். <a href="https://maps.app.goo.gl/FDzMyCoymCQKwmcEA" target="_blank" rel="noopener noreferrer" style="color:var(--maroon);text-decoration:underline;font-weight:600;">சாந்தி ஸ்வீட்ஸ்</a> முயற்சியுங்கள்!' },
    ...
    { sel: '.attractions-grid .attraction-card:nth-child(4) .attraction-desc', en: 'A museum showcasing the rich cultural heritage and archaeological finds of the Thamirabarani (Porunai) river civilisation.', ta: 'தாமிரபரணி (பொருநை) நதி நாகரிகத்தின் பண்பாட்டு பாரம்பரியம் மற்றும் தொல்பொருள் கண்டுபிடிப்புகளை காட்சிப்படுத்தும் அருங்காட்சியகம்.' },
    { sel: '.attractions-grid .attraction-card:nth-child(5) .attraction-desc', en: 'A significant archaeological excavation site revealing ancient Tamil civilisation artefacts and heritage.', ta: 'பண்டைய தமிழ் நாகரிக தொல்பொருட்களை வெளிக்கொணரும் முக்கியமான தொல்பொருள் அகழ்வாய்வு நிலையம்.' },
    { sel: '.attractions-grid .attraction-card:nth-child(6) .attraction-desc', en: 'An ancient burial site dating back 3,800 years — one of the most important archaeological discoveries in India.', ta: '3,800 ஆண்டுகள் பழமையான புதைகுழி , இந்தியாவின் மிக முக்கியமான தொல்பொருள் கண்டுபிடிப்புகளில் ஒன்று.' },
    ...
    { sel: '.attractions-grid .attraction-card:nth-child(7) .attraction-desc', en: 'A beautiful waterfall nestled in the Western Ghats — a serene spot for nature lovers.', ta: 'மேற்குத் தொடர்ச்சி மலையில் அமைந்த அழகிய அருவி , இயற்கை ஆர்வலர்களுக்கான அமைதியான இடம்.' },
    { sel: '.attractions-grid .attraction-card:nth-child(8) .attraction-desc', en: 'A scenic waterfall near Papanasam, believed to be blessed by Sage Agasthiyar.', ta: 'பாபநாசம் அருகே உள்ள இயற்கை எழில் கொஞ்சும் அருவி, அகத்திய முனிவரின் அருளால் புனிதமானது.' },
    { sel: '.attractions-grid .attraction-card:nth-child(9) .attraction-desc', en: 'The "Spa of South India" — scenic waterfalls surrounded by the Western Ghats, ~60 km away.', ta: '"தென் இந்தியாவின் ஆரோக்கிய நீரூற்று" , மேற்குத் தொடர்ச்சி மலைகளால் சூழப்பட்ட அழகிய அருவிகள், ~60 கி.மீ. தொலைவில்.' },
    { sel: '.attractions-grid .attraction-card:nth-child(10) .attraction-desc', en: 'One of the six abodes of Lord Murugan, a magnificent seaside temple ~80 km from the city.', ta: 'முருகப் பெருமானின் ஆறுபடை வீடுகளில் ஒன்று, நகரத்திலிருந்து ~80 கி.மீ. தொலைவிலுள்ள கடலோர கோவில்.' },
    // Attraction links
